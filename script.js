...
const playlist = [
  { src: 'file4/ghequa.mp3', name: 'Ghé Qua' },
  { src: 'file1/nhuanhmo.mp3', name: 'Như Anh Mơ' },
  { src: 'assets/10ngannam.mp3', name: '10 Ngàn Năm' },
  { src: 'file2/langdu.mp3', name: 'Lãng Du' },
  { src: 'file2/ngaunhien.mp3', name: 'Ngẫu Nhiên' },
  { src: 'file3/comotnguoiluoncuoikhianhden.mp3', name: 'Có Một Người Luôn Cười Khi Anh Đến' },
  { src: 'file2/matbiec.mp3', name: 'Mắt Biếc' },
  { src: 'file4/giacungnhauladuoc.mp3', name: 'Già Cùng Nhau Là Được' },
  { src: 'file2/thoitreroichacanhphaiveday.mp3', name: 'Thôi Trễ Rồi Chắc Anh Phải Về Đây' },
  { src: 'file1/songbien.mp3', name: 'Sóng Biển' },
  { src: 'file1/quanhungtiengve.mp3', name: 'Qua Những Tiếng Ve' },
  { src: 'file4/lacdan.mp3', name: 'Lạc Đàn' },
  { src: 'file1/nhungocuamau.mp3', name: 'Những Ô Cửa Màu' },
  { src: 'file2/mothuothanhbinh.mp3', name: 'Một Thuở Thành Bình' },
  { src: 'file4/huongrung.mp3', name: 'Hương Rừng' },
  { src: 'file3/dungchandunglai.mp3', name: 'Dừng Chân Đứng Lại' },
  { src: 'file3/diquahoacuc.mp3', name: 'Đi Qua Hoa Cúc' },
  { src: 'file3/classiclove.mp3', name: 'Classic Love' },
